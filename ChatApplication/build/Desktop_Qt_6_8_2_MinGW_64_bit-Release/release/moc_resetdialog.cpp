...
static constexpr auto qt_meta_stringdata_ZN11ResetDialogE = QtMocHelpers::stringData(
    "ResetDialog",
    "switchLogin",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11ResetDialogE[] = {
...
Q_CONSTINIT const QMetaObject ResetDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11ResetDialogE.offsetsAndSizes,
    qt_meta_data_ZN11ResetDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11ResetDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void ResetDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ResetDialog::*)();
            if (_q_method_type _q_method = &ResetDialog::switchLogin; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ResetDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11ResetDialogE.stringdata0))
