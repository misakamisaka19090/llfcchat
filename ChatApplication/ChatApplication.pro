...
# 以下定义会使编译器在你使用 Qt 中已标记为废弃的任何特性时发出警告
# 具体的警告内容取决于你的编译器。请查阅废弃 API 的文档，以了解如何将代码迁移，避免使用这些废弃的特性。
...
# 你也可以使代码在使用废弃的 API 时编译失败。
# 为了实现这一点，请取消注释以下行。
# 你还可以选择仅禁用某个版本之前的废弃 API。
#DEFINES += QT_DISABLE_DEPRECATED_BEFORE=0x060000    # 禁用所有在 Qt 6.0.0 之前废弃的 API
...
CONFIG(debug, debug|release) {
    ...
    message("!!! Post-link copy static 执行了")
